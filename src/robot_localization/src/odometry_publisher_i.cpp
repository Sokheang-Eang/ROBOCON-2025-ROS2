...
{
public:
    OdometryPublisher() : Node("odom_robot_i")
    {
...
private:
    void pose_callback(const geometry_msgs::msg::Pose2D::SharedPtr msg)
    {
        ...
        // Data Logging
        // RCLCPP_INFO(this->get_logger(), "robot_i - x: %.2f, y: %.2f, theta: %.2f", current_x, current_y, current_theta);
    }
    void publish()
    {
        // Get current time
        ...
        odom_trans.child_frame_id = "robot_i";
